...
class MoreGroupsTableViewController: UITableViewController, UISearchBarDelegate {
    ...
    func fillMoreGroupsArray() {
        ...
        let group4 = Group(name: "Pessimists group", avatar: UIImage(named: "pessimists")!)
        let group5 = Group(name: "Optimists group", avatar: UIImage(named: "optimists")!)
        let group6 = Group(name: "Realists group", avatar: UIImage(named: "realists")!)
